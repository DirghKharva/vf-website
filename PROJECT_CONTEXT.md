...
6.  **Salt Category (`/products/salt`):** Showcases 6 raw/edible varieties (including merged Refined Salt / Table Salt) and 3 visual packaging options (Consumer Packs, Bags/Sacks, and Bulk) using optimized mockup images.
